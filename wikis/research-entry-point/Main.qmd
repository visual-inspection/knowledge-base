...
- **`Semi-supervised Learning`**
  ...
  - Domain Adaptation
    - Zero-Shot Learning
      - Papers:
        - [@chang2008dataless]: "[@chang2008dataless]{.title}"
        - [@larochelle2008zerodata]: "[@larochelle2008zerodata]{.title}"
        - [@jeong2023winclip]: "[@jeong2023winclip]{.title}"
        - [@deng2023anovl]: "[@deng2023anovl]{.title}"
      - Repositories:
